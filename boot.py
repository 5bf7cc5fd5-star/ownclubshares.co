...
INJECT = [
    '<link rel="stylesheet" href="/static/app-shell-fix.css?v=56">',
    '<script src="/static/login-tight.js?v=56"></script>',
    '<script src="/static/app-shell-fix.js?v=56"></script>',
]
block = "\n".join(INJECT)
for name in ("index.html", "frontend.html"):
    p = root / name
